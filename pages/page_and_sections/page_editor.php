        ...
        <div class="w-full md:w-3/4 bg-white rounded-lg shadow-sm p-4 order-1 md:order-2">
            ...
            <div class="hidden md:flex flex-wrap border-b border-gray-300 mb-6">
                ...
                <div class="font-mono text-gray-700 border border-gray-300 px-4 py-2 rounded-t mr-1 cursor-pointer hover:bg-gray-100 <?php echo ($page_key === $current_page) ? 'bg-blue-50 border-b-0' : ''; ?>" 
                     data-page="<?php echo $page_key; ?>" onclick="window.location.href='?page=<?php echo $page_key; ?>'">
            ...
            <div class="md:hidden mb-6">
                <select class="w-full border border-gray-300 rounded p-2 font-mono text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500" 
            ...
            <div class="space-y-4" id="sortable-sections">
                ...
                ?>
                <div class="border border-gray-300 rounded p-4 cursor-move hover:bg-gray-50" data-section-index="<?php echo $section_index; ?>">
                    ...
                    <div class="flex justify-center mt-3 space-x-2">
                        <button class="text-blue-600 hover:text-blue-800" onclick="editSection('<?php echo $section['path']; ?>')">
                            <i class="fas fa-edit"></i> Edit
                        </button>
                        <button class="text-red-600 hover:text-red-800" onclick="confirmDeleteSection('<?php echo $section_index; ?>', '<?php echo $section['name']; ?>')">
            ...
            <div class="mt-6 flex flex-col md:flex-row gap-4">
                <button class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition duration-300 flex items-center justify-center flex-1">
                    <i class="fas fa-plus mr-2"></i> Add New Section
                </button>
                <button id="generatePageBtn" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition duration-300 flex items-center justify-center flex-1" 
                        onclick="generatePage('<?php echo $current_page; ?>')">
                    <i class="fas fa-code mr-2"></i> Generate <?php echo ucfirst($current_page); ?>
                </button>
            </div>
        </div>
